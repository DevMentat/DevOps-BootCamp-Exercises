...
# fetch NodeJS project archive from nexus repo
curl -X GET http://project-manager:projectmanager@192.168.64.7:8081/repository/NPM/bootcamp-node-project/-/bootcamp-node-project-1.0.0.tgz --output nodejsapp.tgz

# extract the project archive to ./package folder
tar zxvf ./nodejsapp.tgz
